...
public class TaskList {
    ...
    //mapped by means ==> Look to the instance variable taskList on the task class for more information about this relationship
    //CascadeType.REMOVE specifies that when we delete a task list all the tasks will be deleted too
    //CascadeType.PERSIST means that any new task that it contains will be saved too
